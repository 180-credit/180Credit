                                    ...
                                    <div class="profile-bottom p-3">
                                        <div class="profile-bot-top d-flex justify-content-between">
                                            ...
                                            <div class="prof-midd-right">
                                                <ul class="list-unstyled mb-0">
                                                    <li><?= isset($userCompanyProfile->offersFreeConsultations) && $userCompanyProfile->offersFreeConsultations == 1 ? '<i class="fas fa-check-circle"></i>' : '<i class="fas fa-times-circle clr-red"></i>' ?>
                                                        Free consultations
                                                    </li>
                                                    <?php
                                                    ...
                                                    if (!empty($userCompanyProfile->public_phone)) {
                                                        ?>
                                                        <li>
                                                            <i class="fas fa-phone"></i><?= $userCompanyProfile->public_phone ?>
                                                        </li>
                                                        <?php
                                                    }
                                                            ...
                                                            if (!empty($userCompanyProfile->public_phone) || $userCompanyProfile->public_phone != "") {
                                                                ...
                                                                <div class="map-button-block">
                                                                    ...
                                                                    <button type="button"
                                                                        ...
                                                                        Call <?= $userCompanyProfile->public_phone ?></button>
                                                                </div>
                                                                <?php
                                                            }
                                                            ?>
