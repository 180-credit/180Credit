<div class="container login-btn-block">
    <div class="row">
        <h1 style="width: 100%;margin-top:20px ">Privacy Policy</h1>
        <p>
            <i>Last Revised: April 19, 2017</i>
            <br>
            <br>
            Thanks for using 180Credit. This privacy policy ("Policy") applies to your use of 180Credit's website, products, apps, and services (together, the "Services"). The Policy is intended to inform you about how we collect and use information so you can make an informed decision about using the Services. Please read it carefully before using the Services or submitting any information to us. If you do not agree to any part of this Policy, then you should stop accessing the Services.
            <br>
        </p>
        <h3 style="width: 100%">What information do we collect?</h3>
        <p>
            <b>1. Usage/log information</b><br>
            ...
            <br><br><b>3. Personal information</b><br>
            We collect and store Personal Information that you provide to us when accessing or using the Services. "Personal Information" means information relating to a person who is or can be identified directly from that information. This includes your name, address, telephone number, email address, credit card or other account number. Personal Information does not include: (1) aggregated or anonymized information; (2) any publicly available information about lawyers; (3) information about you that is provided by third parties; or (4) information that is posted to publicly accessible areas of the Services. Examples of Personal Information we collect include information that you provide when you (a) create or update your 180Credit account, (b) communicate with us, (c) purchase services from us, (d) contact or recommend a lawyer, (e) submit client ratings or peer endorsements. If you are a lawyer and claim or update your profile ("Profile"), or post information using your Profile, we may also collect verification information.
            <br><br><b>4. Publicly posted Information</b><br>
        ...
        <h3 style="width: 100%">How we use the information we collect</h3>
        <p>
            <b>1. Non-personal information</b><br>
            ...
            <br><br><b>2. Personal information</b><br>
            ...
            <br><br><b>3. Third party service providers</b><br>
        ...
        <h3 style="width: 100%">Managing your preferences</h3>
        <p>
            <b>1. Managing online advertising preferences</b><br>
            We respect all browser instructions for setting or rejecting cookies on generally available browsers. This is one way to manage your preferences regarding the collection of information by 180Credit. Additionally, and because data acquired across the internet is often associated with information about you acquired in other places online, you can manage online advertising preferences via these links:
            <br><u>Google Ad Preferences Manager</u>
            <br><u>Google Analytics Opt-out Browser Add-on</u>
            <br><u>Facebook Ad Preferences Manager</u>
            <br><u>Network Advertising Initiative</u>
            <br><u>Digital Advertising Alliance</u>
            While 180Credit will follow any such preferences, we make no representations regarding whether third parties, including third party ad platforms, will do so.
            <br><br><b>2. Managing your newsletter/communications preferences</b><br>
            You may select whether or not you wish to continue to receive newsletters or other communications by changing your account settings on the email and notifications page of the My Account section of the Services. In addition, you may "opt out" of receiving any category of subscription, marketing or promotional email from 180Credit by following the unsubscribe instructions or using the unsubscribe links within the emails we send. Please note, however, that as long as you maintain an account, you may not "opt out" of receiving service or account-related emails from 180Credit.
            <br><br><b>Requests for information; disclosure for enforcement purposes</b><br>
            ...
            <br><br><b>Updating your listing information and public posts</b><br>
            ...
            <br><br><b>Third party websites and practices</b><br>
            ...
            <br><br><b>Transfers of information</b><br>
            Information about our customers, including Personal Information, may be disclosed as part of any merger, acquisition, debt financing, sale of company assets, as well as in the event of an insolvency, bankruptcy or receivership in which Personal Information could be transferred to third parties as one of 180Credit's business assets. In such an event, we will attempt to notify you before your Personal Information is transferred, but you may not have the right to opt out of any such transfer.
            <br><br><b>Children</b><br>
            ...
            <br><br><b>Changes to the policy</b><br>
            We may change the provisions of this Policy at any time, and we will always post the most up-to-date version on our website. If we determine, in our sole discretion, that a modification to this Policy materially affects your rights, we will notify you (by, for example, sending a message to your account email or posting on the 180Credit Blog).
            ...
            180Credit, LLC<br>
            1425 West High Street<br>
            Haddon Heights, NJ 080335<br>
