<div class="container login-btn-block">
    <div class="row justify-content-center my-5 py-5">
        <div class="col-md-6">
            ...
            <form  id="provider_form" method="post" action="<?= base_url(); ?>login/signup_store">
                ...
                <button type="button" id="submit-provider" class="btn btn-primary btn-block">Save and continue</button>
            </form>
        </div>
    </div>
</div>
<script>
    $(document).ready(function(){
        ...
        $("#submit-provider").click(function(){
            console.log($("#provider_form").valid());
