...
<section class="page-contents">
    ...
    <div class="rightSection col-xl-12 col-md-12 col-sm-12 col-xs-12 persons2 " style="border-right: none;padding: 0;border-left: 1px solid rgba(0, 0, 0, .10);border-top: 1px solid rgba(0, 0, 0, .10); text-overflow: ellipsis;overflow-x: hidden;overflow-y: hidden " id="rightSection">
        ...
        <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12  pad-5 hidden" id="blockOptions"  >
            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12 pad-5 hidden" id="block" style="cursor: pointer;color: #75aef3;padding-right: 0;"><i class="fa fa-toggle-off pad-10"></i><strong>Block</strong></div>
            <div class="col-md-12 col-xl-12 col-xs-12 col-sm-12 pad-5 hidden" id="unblock" style="cursor: pointer;color: #75aef3;padding-right: 0;"><i class="fa fa-toggle-on pad-10"></i><strong>Unblock</strong></div>
        </div>
