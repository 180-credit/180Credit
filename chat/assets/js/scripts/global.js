...
$(function() {
   ...
   $('#scrollspy').affix({
	...
	$('li.settings-tab').hover(function () {
	...
	$('#header-dropdown').on('click',function (e) {
		...
		$('.group-main').slideToggle('slow', function() {
			if ($('.group-main').is(':hidden')) {
				$('#content-block').removeClass("marginTop");
				$('.marginTop').css("margin-top",0);
				$('.be-detail-container').css("padding-top",0);
			} else {

				$('#content-block').addClass("marginTop");
				$('.marginTop').css("margin-top",90);
				$('.be-detail-container').css("padding-top",40);
			}
		});
	});
